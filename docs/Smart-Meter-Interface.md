...
??? summary "View script"
    ...
    #
    ```	
This meter needs to have "inf"-mode ON. Enter Pin Number and cycle through the menu by short pressing the button until you reach inf. By default it is set to off. To change long press the button.
